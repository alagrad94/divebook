...
export default class Register extends Component {
  ...
  render() {
    return (
      <Grid className="registration_grid"
        areas ={[
        ...
        gap='none'
      >
      <Box gridArea='logo' background='#861214' className="registration_grid_left">
        <h2 className="registration_grid_logo">Welcome to Divebook</h2>
        <h5 className="registration_grid_logo_subtitle">Please Register</h5>
      </Box>

        <Box gridArea='form' background='none' className="registration_grid_right">
          <Form className="registration_form_whole whole_form" onSubmit={this.getAllUsers}>
            <Form.Row>
              <Form.Group className="registration_form_group" controlId="userName">
              ...
              <Form.Group className="registration_form_group" controlId="password">
            ...
            <Form.Group className="registration_form_group" controlId="firstName">
            ...
            <Form.Group className="registration_form_group" controlId="lastName">
          ...
          <Form.Row className="form_row">
            <Form.Group className="registration_form_group" controlId="birthDate">
            ...
            <Form.Group className="registration_form_group" controlId="gender">
          ...
          <Form.Row className="form_row">
            <Form.Group className="registration_form_group" controlId="certLevel">
            ...
            <Form.Group className="registration_form_group" controlId="certOrg">
          ...
          <Form.Row className="form_row">
            <Form.Group className="registration_form_group" controlId="city">
            ...
            <Form.Group className="registration_form_group" controlId="state">
            ...
            <Form.Group className="registration_form_group" controlId="zip">
              ...
              <Form.Group className="registration_form_group" controlId="country">
          ...
          <Form.Row className="form_row">
            <Form.Group className="registration_form_group" controlId="diveInterests">
          ...
          <Form.Row className="form_row">
            <Button as="input" type="submit" size="sm" className="button registration_form registration_submit_button" />
          </Form.Row>
        </Form>
      </Box>
    </Grid>
